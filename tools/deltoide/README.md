...
Deltoide analyses a dataset (file, directory, or block device) and produces compression and deduplication distribution profiles, the output is JSON suitable for configuring Prismo's content generators.
